...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct  5 18:41:07 2020
...
def get_best_params(gscv, score_column='mean_test_score'):
    """
...
cv_results_path = './model_evaluation/l0_grid_' + type_proc + type_os + '_nostop.csv'
model_out_path = './models/l0_' + type_proc + type_os + '_nostop.csv'
model_eval_path = './model_evaluation/l0_metrics_' + type_proc + type_os + '_nostop.csv'
...
X = train_data['texto_ed']
y = train_data['etiqueta_etapa0']
...
#%%
#files = get_paths(d='./models/')
#best_params = [joblib.load(i) for i in files]
#%%
n_splits = 5
